...
'<div id="lkr-body" class="lkr-body">' +
  '<div class="lkr-msg">' +
    ...
    '<div class="lkr-alert">' +
      ...
      '<p>Для регистрации вам понадобится <a target="_blank" href="http://ru.wikipedia.org/wiki/Страховой_номер_индивидуального_лицевого_счёта">номер страхового свидетельства СНИЛС</a>, и капелька терпения. До голосования допускаются лица, достигшие 18 лет.</p>' + 
    '</div>' +
