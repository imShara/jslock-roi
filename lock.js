...
'<div id="lkr-body" class="lkr-body">' +
  '<div class="lkr-msg">' +
    ...
    '<div class="lkr-alert">' +
      ...
      '<p>Для регистрации вам понадобится <a href="http://ru.wikipedia.org/wiki/Страховой_номер_индивидуального_лицевого_счёта">номер страхового свидетельства СНИЛС</a>, и капелька терпения. До голосования допускаются лица, достигшие 18 лет.</p>' + 
    '</div>' +
  ...
  slide: [
    {
      ...
      html  : '<div class="lkr-act">10. На сайте <a href="https://esia.gosuslugi.ru/sia-web/activation/Index.spr?type=rf">Госуслуг</a> нажмите &#171;Ввести код активации&#187;</div>' +
              '<p>Чтобы начать активацию вашей учётной записи на портале &#171;Госуслуги&#187;, зайдите на <a href="https://www.gosuslugi.ru/">главную страницу</a> портала, нажмите на кнопку &#171;Регистрация&#187; и на открывшейся странице нажмите кнопку &#171;Ввести код активации&#187;.</p>'
    },{
