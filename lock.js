...
w.lk.opt = {
  ...
  shareText: '1 апреля вступает в силу закон, который угрожает интернету',
...
lk.oldMessage = '<div class="lkr-h">Что случилось?</div>' +
'<p>21 июня Государственная Дума РФ <a href="http://lenta.ru/news/2013/06/21/piracylaw/">почти единогласно</a> и в кратчайшие сроки <a href="http://base.consultant.ru/cons/cgi/online.cgi?req=doc;base=LAW;n=148497">приняла закон № 187-ФЗ</a>, широко известный как «антипиратский закон» или «закон о произвольной блокировке» или «русская <a href="http://ru.wikipedia.org/wiki/Stop_Online_Piracy_Act">SOPA</a>».</p>' +
'<div class="lkr-h">Почему это плохо?</div>' + 
'<p>Этот закон даёт широкие возможности для злоупотреблений и недобросовестной конкурентной борьбы, когда злоумышленник может на любом сайте оставить комментарий со ссылкой на пиратский контент, что приведет к закрытию такого интернет-ресурса. Таким образом, под угрозой блокировки оказываются блоги, поисковики, принцип работы которых не позволяет устраивать предварительную модерацию выдачи, публичные торрент трекеры, файловые хранилища, видеохостинги, социальные сети, СМИ. Текст закона противоречит <a href="http://ru.wikipedia.org/wiki/%D0%92%D0%B5%D0%B1_2.0">принципам работы</a> современного свободного интернета.</p>' +
'<p>Более того, из-за технических особенностей организации Сети и невозможности провайдеров блокировать исключительно страницы с контентом, на который подана жалоба правообладателя, ограничение доступа будет распространяться на все ресурсы находящиеся на данном <a href="http://ru.wikipedia.org/wiki/IP-%D0%B0%D0%B4%D1%80%D0%B5%D1%81">IP-адресе</a> (они могут исчисляться <a href="http://habrastorage.org/storage2/39a/1e1/cc5/39a1e1cc541754eee30f8ca06710a217.png">тысячами</a>).</p>' +
'<div class="lkr-h"><a href="http://ru.wikipedia.org/wiki/Когда_они_пришли…">А я здесь при чём?</a></div>' + '<p>Компаниями <a href="http://clubs.ya.ru/company/replies.xml?item_no=67927">Яндекс</a>, <a href="http://googlerussiablog.blogspot.ru/2013/06/google.html">Google</a>, Российской ассоциацией электронных коммуникаций (<a href="http://raec.ru/times/detail/2625/">РАЭК</a>) были предложены поправки к закону, исключающие возможность ложной блокировки не причастных к нелегальной деятельности ресурсов, но Государственной Думой они <a href="http://habrahabr.ru/company/yandex/blog/184182/#comment_6402274">учтены не были</a>.</p>' +
'<p>Может сложиться иллюзия, что ограничения доступа можно обойти техническими средствами. Это не так. Не стоит надеяться на программистов. В случае, если законы подобного уровня проработки будут приниматься дальше, ничто не помешает запретить анонимные cистемы обмена информацией, такие как <a href="http://ru.wikipedia.org/wiki/I2P">I2P</a> или <a href="http://ru.wikipedia.org/wiki/Tor">TOR</a>, ввести лицензирование <a href="http://ru.wikipedia.org/wiki/VPN">VPN</a> и шифрованных туннелей. Если это допустить, то Интернет потеряет независимость.</p>' +
'<div class="lkr-h">Что можно сделать?</div>' + '<p>Ассоциацией пользователей интернета совместно с проектом <a href="http://rublacklist.net/">РосКомСвобода</a> на сайте «Российская общественная инициатива» был организован <a href="https://www.roi.ru/poll/petition/gosudarstvennoe_upravlenie1/otmenit-zakon-o-proizvolnyh-blokirovkah-internet-resursov-ot-02072013-187-fz-zakon-protiv-interneta/">сбор подписей</a> за отмену этого закона. Если под обращением удастся набрать 100.000 подписей, то эта инициатива будет рассмотрена государственными органами. Если вы согласны с тем, что в таком виде этот закон не должен существовать, пожалуйста, поставьте свою подпись под петицией и расскажите всем-всем-всем <span class="lkr-mark">#ЗаконПротивИнтернета</span></p>' +
...
lk.newMessage = '<div class="lkr-h">Что случилось?</div>' +
  '<p>21 июня Государственная Дума РФ <a href="http://base.consultant.ru/cons/cgi/online.cgi?req=doc;base=LAW;n=148497">приняла закон № 187-ФЗ</a>, широко известный как «антипиратский закон» или «закон о произвольной блокировке» или «русская SOPA».</p>' +
  '<p>Под угрозой блокировки оказываются блоги, поисковики, торрент трекеры, файловые хранилища, видеохостинги, социальные сети, СМИ. Текст закона противоречит <a href="http://ru.wikipedia.org/wiki/Веб_2.0">принципам работы</a> современного свободного интернета.</p>' +
  '<div class="lkr-h">Что можно сделать?</div>' + '<p>На сайте Российской общественной инициативы был организован сбор подписей за отмену этого закона. Если под обращением удастся собрать 100.000 подписей, то он будет пересмотрен. Если вы согласны с тем, что в таком виде закон не должен существовать, поставьте, пожалуйста, свою подпись под петицией. Или если вам <a href="http://ru.wikipedia.org/wiki/Когда_они_пришли…">безразлично</a> будущее Рунета, просто продолжите работу по завершению отсчета таймера. </p>' +
  '<p>Регистрация на этом сайте считается трудным делом, поэтому мы написали подробную иллюстрированную инструкцию, которая поможет вам зарегистрироваться и проголосовать.</p>';

if (lk.opt.customMessage)
  lk.message = lk.opt.customMessage;
else if (isSeenOld)
  lk.message = lk.newMessage;
else
  lk.message = lk.oldMessage;
  ...
  slide: [
    {
      ...
      html:   '<div class="lkr-act">1. Зайдите на сайт <a href="http://gosuslugi.ru">gosuslugi.ru</a> и начните регистрацию</div>' +
              '<p>Для голосования на сайте &#171;Российская Общественная Инициатива&#187; (сокращённо РОИ) необходимо зарегистрироваться на портале &#171;Госуслуги&#187;. Чтобы начать регистрацию, зайдите на <a href="https://www.gosuslugi.ru/">главную страницу</a> портала &#171;Госуслуги&#187; и нажмите кнопку &#171;Регистрация&#187; в правом верхнем углу.</p>' +
      ...
      html  : '<div class="lkr-act">7. Введите пришедшие коды подтверждения</div>' +
              '<p>Введите коды подтверждения контактных данных из сообщений, пришедших на ваш адрес электронной почты и мобильный телефон. При необходимости воспользуйтесь функцией &#171;Отправить код повторно&#187;. Получив и введя коды подтверждения, нажмите кнопку &#171;Далее&#187;</p>'    
    },{
      btntxt: ': Активация учётной записи',
      html  : '<div class="lkr-act">8. Результат регистрации</div>' +
              '<p>Поздравляем, регистрация на портале &#171;Госуслуги&#187; завершена! В случае, если вы выбрали активацию через Ростелеком, вам будет предложено <a href="http://www.gosuslugi.ru/pgu/maps">найти центр обслуживания на карте</a>.</p>'   
    },{
      btntxt: ': Ввод кода активации',
      html  : '<div class="lkr-act">9. Введите ваш номер СНИЛС и код активации</div>' +
      ...
      html  : '<div class="lkr-act">10. Результат выполнения активации</a></div>' +
      ...
      html  : '<div class="lkr-act">11. &#171;Российская Общественная Инициатива&#187;, авторизация</a></div>' +
              '<p>Чтобы начать авторизацию на сайте РОИ, перейдите на <a href="https://www.roi.ru/">главную страницу</a> сайта и нажмите &#171;Вход&#187; в правом верхнем углу. Вы будете перенаправлены на страницу авторизации на портале &#171;Госуслуги&#187;.</p>'
    },{
      btntxt: ': Ввод авторизационных данных',
      html  : '<div class="lkr-act">12. Ввод данных авторизации на портале &#171;Госуслуги&#187;</a></div>' +
      ...
      html  : '<div class="lkr-act">13. Ввод дополнительной информации</a></div>' +
      ...
      html  : '<div class="lkr-act">14. Результат авторизации на РОИ</a></div>' +
      ...
      btntxt: '',
      html  : '<div class="lkr-act">17. Результат голосования</a></div>' +
...
lk.manual.nav = function(dir) {
  ...
  if (lk.manual.step+dir >= 0 && lk.manual.step+dir <= lk.manual.slide.length)
    lk.manual.step += dir;
  else 
    return;
